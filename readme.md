...
| markupTop      | `Chocolat.prototype.markupTop`                 | Function to use a custom markup for the `chocolat-top` element, useful to move the image description at the top of the image for example. <br> See `markupTop` function in `dist/js/jquery.chocolat.js` for more information 
|  
                                                                                                                                                                                                |
| markupBottom      | `Chocolat.prototype.markupBottom`                 | Function to use a custom markup for the `chocolat-bottom` element, useful to move the closing icon at the bottom of the image for example. <br> See `markupBottom` function in `dist/js/jquery.chocolat.js` for more information 
|  
                                                                                                                                                                                                |
