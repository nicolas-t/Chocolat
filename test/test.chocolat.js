describe("Chocolat", function() {
    describe("Opening", function() {
        ...
        it("should call markup function and create markup", function() {
            var chocolat = $('#example0').Chocolat({
                loop : true,
                container : $('#container'),
            }).data('chocolat');
    ...
    describe("Destroy method", function() {
        ...
        it("should remove data from calling element", function() {
            ...
            var chocolat = $('#example0').Chocolat().data('chocolat');
    ...
    describe("ImageSize cover", function() {
        ...
        it("should add class chocolat-cover to parent", function(done) {
            var chocolat = $('#example0').Chocolat({imageSize: 'cover'}).data('chocolat');
...
function getExpectedDimensions (chocolat) {
    ...
    var containerOutMarginH = chocolat.api().getElem('top').outerHeight(true) + chocolat.api().getElem('bottom').outerHeight(true);
    var containerOutMarginW = chocolat.api().getElem('left').outerWidth(true) + chocolat.api().getElem('right').outerWidth(true);
